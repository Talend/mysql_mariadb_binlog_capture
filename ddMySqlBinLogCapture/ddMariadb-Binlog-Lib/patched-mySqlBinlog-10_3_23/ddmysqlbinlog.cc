...
MyLogFile l_LogFile;
bool	l_fExitApp;
long	l_lActivateTrace;
long	l_lTraceLevel;
unsigned long l_ulIndex = 0;

static char	l_szMsg[2048];	// Use in main process
char **l_defaults_argv;
MY_TMPDIR tmpdir;
                          ...
                          my_off_t pos, const char *logname)
{
  ...
  */
      ...
      (ev_type == FORMAT_DESCRIPTION_EVENT))
  {
	...
	// ADD GAMMA
	////////////////////////////////////////
	DEBUG_EVENT(if (l_lActivateTrace > 0) l_LogFile.Write("process_event <%s> event_type: %d-%s", logname, ev_type, ev->get_type_str());)
	////////////////////////////////////////
    ...
    case QUERY_COMPRESSED_EVENT:
    {
		...
		// ADD GAMMA
		////////////////////////////////////////
		DEBUG_EVENT(if (l_lActivateTrace > 0) l_LogFile.Write("process_event <%s> event_type: %d-%s QUERY_EVENT", logname, ev_type, ev->get_type_str());)
		////////////////////////////////////////
      ...
      else
      {
		...
		// ADD GAMMA
		////////////////////////////////////////
		fprintf(result_file, "*!QUERY!%lld!%lld!%s!%lu!\n", pos, ev->log_pos, ((Query_log_event*)ev)->query, l_ulIndex);
		////////////////////////////////////////
    ...
    case CREATE_FILE_EVENT:
    {
		...
		// ADD GAMMA
		////////////////////////////////////////
		DEBUG_EVENT(if (l_lActivateTrace > 0) l_LogFile.Write("process_event <%s> event_type: %d-%s CREATE_FILE_EVENT", logname, ev_type, ev->get_type_str());)
		////////////////////////////////////////
    ...
    case APPEND_BLOCK_EVENT:
		...
		// ADD GAMMA
		////////////////////////////////////////
		DEBUG_EVENT(if (l_lActivateTrace > 0) l_LogFile.Write("process_event <%s> event_type: %d-%s APPEND_BLOCK_EVENT", logname, ev_type, ev->get_type_str());)
		////////////////////////////////////////
    ...
    case EXEC_LOAD_EVENT:
    {
		...
		// ADD GAMMA
		////////////////////////////////////////
		DEBUG_EVENT(if (l_lActivateTrace > 0) l_LogFile.Write("process_event <%s> event_type: %d-%s EXEC_LOAD_EVENT", logname, ev_type, ev->get_type_str());)
		////////////////////////////////////////
    ...
    case FORMAT_DESCRIPTION_EVENT:
		...
		// ADD GAMMA
		////////////////////////////////////////
		DEBUG_EVENT(if (l_lActivateTrace > 0) l_LogFile.Write("process_event <%s> event_type: %d-%s FORMAT_DESCRIPTION_EVENT", logname, ev_type, ev->get_type_str());)
		////////////////////////////////////////
    ...
    case EXECUTE_LOAD_QUERY_EVENT:
    {
		...
		// ADD GAMMA
		////////////////////////////////////////
		DEBUG_EVENT(if (l_lActivateTrace > 0) l_LogFile.Write("process_event <%s> event_type: %d-%s EXECUTE_LOAD_QUERY_EVENT", logname, ev_type, ev->get_type_str());)
		////////////////////////////////////////
    ...
    case ANNOTATE_ROWS_EVENT:
		...
		// ADD GAMMA
		////////////////////////////////////////
		DEBUG_EVENT(if (l_lActivateTrace > 0) l_LogFile.Write("process_event <%s> event_type: %d-%s ANNOTATE_ROWS_EVENT", logname, ev_type, ev->get_type_str());)
		////////////////////////////////////////
    ...
    case TABLE_MAP_EVENT:
    {
		...
		// ADD GAMMA
		////////////////////////////////////////
		strcpy(eventName, "TABLE_MAP_EVENT"); 
		DEBUG_EVENT(if (l_lActivateTrace > 0) l_LogFile.Write("process_event <%s> event_type: %d-%s TABLE_MAP_EVENT", logname, ev_type, ev->get_type_str());)
		////////////////////////////////////////
	  ...
	  // ADD GAMMA
	  ////////////////////////////////////////
	  strcpy(tableName, map->get_table_name());
	  tableId = map->get_table_id();
	  ////////////////////////////////////////
    ...
    case DELETE_ROWS_COMPRESSED_EVENT_V1:
    {
		...
		// ADD GAMMA
		////////////////////////////////////////
		if (ev_type == WRITE_ROWS_EVENT)			strcpy(eventName, "WRITE_ROWS_EVENT");
		if (ev_type == DELETE_ROWS_EVENT)			strcpy(eventName, "DELETE_ROWS_EVENT");
		if (ev_type == UPDATE_ROWS_EVENT)			strcpy(eventName, "UPDATE_ROWS_EVENT");
		if (ev_type == PRE_GA_WRITE_ROWS_EVENT)		strcpy(eventName, "PRE_GA_WRITE_ROWS_EVENT");
		if (ev_type == PRE_GA_DELETE_ROWS_EVENT)	strcpy(eventName, "PRE_GA_DELETE_ROWS_EVENT");
		if (ev_type == PRE_GA_UPDATE_ROWS_EVENT)	strcpy(eventName, "PRE_GA_UPDATE_ROWS_EVENT");
		if (ev_type != TABLE_MAP_EVENT)				rowEvent = true;
		DEBUG_EVENT(if (l_lActivateTrace > 0) l_LogFile.Write("process_event <%s> event_type: %d-%s ..._ROWS_EVENT [%s]", logname, ev_type, ev->get_type_str(), eventName);)
		////////////////////////////////////////
	  ...
	  ////////////////////////////////////////
	  if (is_stmt_end)
		fprintf(result_file, "*!STMT!%lld!%lld!%lu!*\n", pos, ev->log_pos, l_ulIndex);
	  ////////////////////////////////////////
    ...
    case PRE_GA_UPDATE_ROWS_EVENT:
    {
		...
		// ADD GAMMA
		////////////////////////////////////////
		DEBUG_EVENT(if (l_lActivateTrace > 0) l_LogFile.Write("process_event <%s> event_type: %d-%s GA_..._ROWS_EVENT", logname, ev_type, ev->get_type_str());)
		////////////////////////////////////////
    ...
    default:
      ...
      if (ev->print(result_file, print_event_info))
		...
		// ADD GAMMA
		////////////////////////////////////////
		DEBUG_EVENT(if (l_lActivateTrace > 0) l_LogFile.Write("process_event <%s> event_type: %d-%s DEFAULT", logname, ev_type, ev->get_type_str());)
		if (ev_type == XID_EVENT)
		{
			if (ev_type != TABLE_MAP_EVENT && !rowEvent)
			{
				char buf[64];
				Xid_log_event *e = (Xid_log_event*)ev;
				longlong10_to_str(e->xid, buf, 10);
				DEBUG_EVENT(if (l_lActivateTrace > 0) l_LogFile.Write("process_event <%s> event_type: %d-%s xid:<%s>", logname, ev_type, ev->get_type_str(), buf);)
				///!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
				// COMMIT ==> stop analyse
				///!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
				fprintf(result_file, "*!COMMIT!%lld!%lld!%s!%lu!*\n", pos, ev->log_pos, buf, l_ulIndex);
			}
		}
		if (ev_type == GTID_EVENT)
		{
			char buf[64];
			Gtid_log_event *e = (Gtid_log_event*)ev;
			longlong10_to_str(e->seq_no, buf, 10);
			DEBUG_EVENT(if (l_lActivateTrace > 0) l_LogFile.Write("process_event <%s> event_type: %d-%s seq_no:<%s>", logname, ev_type, ev->get_type_str(), buf);)
			longlong10_to_str(e->commit_id, buf, 10);
			DEBUG_EVENT(if (l_lActivateTrace > 0) l_LogFile.Write("process_event <%s> event_type: %d-%s commit_id:<%s>", logname, ev_type, ev->get_type_str(), buf);)
			fprintf(result_file, "*!BEGIN!%lld!%lld!%lld!*\n", pos, ev->log_pos, e->seq_no);
		}
...
static Exit_status safe_connect()
{
  ...
  // ADD GAMMA
  ////////////////////////////////////////
  DEBUG_EVENT(if (l_lActivateTrace && l_lTraceLevel>TRACE_LOOP) l_LogFile.Write("safe_connect...");)
  ////////////////////////////////////////
  ...
  if (!mysql)
  {
	  ...
	  // ADD GAMMA
	  ////////////////////////////////////////
	  if (l_lActivateTrace && l_lTraceLevel>TRACE_LOOP) l_LogFile.Write("safe_connect Failed on mysql_init.");
	  ////////////////////////////////////////
  ...
  if (!mysql_real_connect(mysql, host, user, pass, 0, port, sock, 0))
  {
	  ...
	  // ADD GAMMA
	  ////////////////////////////////////////
	  if (l_lActivateTrace && l_lTraceLevel>TRACE_LOOP) l_LogFile.Write("safe_connect Failed on connect: %s", mysql_error(mysql));
	  ////////////////////////////////////////
...

{
  ...
  // ADD GAMMA
  ////////////////////////////////////////
  DEBUG_EVENT(if (l_lActivateTrace && l_lTraceLevel>TRACE_LOOP) l_LogFile.Write("dump_remote_log_entries <%s>", logname);)
  ////////////////////////////////////////
  ...
  */
  ...
  // ADD GAMMA
  ////////////////////////////////////////
  DEBUG_EVENT(if (l_lActivateTrace && l_lTraceLevel>TRACE_LOOP) l_LogFile.Write("dump_remote_log_entries(a) <%s>", logname);)
  ////////////////////////////////////////
  ...
  // ADD GAMMA
  ////////////////////////////////////////
  DEBUG_EVENT(if (l_lActivateTrace && l_lTraceLevel>TRACE_LOOP) l_LogFile.Write("dump_remote_log_entries(b) <%s>", logname);)
  ////////////////////////////////////////
  /*
  ...
  */
  ...
  // ADD GAMMA
  ////////////////////////////////////////
  DEBUG_EVENT(if (l_lActivateTrace && l_lTraceLevel>TRACE_LOOP) l_LogFile.Write("dump_remote_log_entries(c) <%s>", logname);)
  ////////////////////////////////////////
  ...
  // ADD GAMMA
  ////////////////////////////////////////
  DEBUG_EVENT(if (l_lActivateTrace > 0) l_LogFile.Write("dump_remote_log_entries <%s> simple_command OK", logname);)
  ...
  for (;;)
  {
	  ...
	  if (l_fExitApp)
	  {
		  sprintf(l_szMsg, "Exit app : dump_remote_log_entries(1)");
		  if (l_lActivateTrace > 0) l_LogFile.Write(l_szMsg);
		  DBUG_RETURN(OK_STOP);
	  }
	  DEBUG_EVENT(if (l_lActivateTrace > 0) l_LogFile.Write("dump_remote_log_entries <%s> cli_safe_read...", logname);)
	  ////////////////////////////////////////
	...
	// ADD GAMMA
	////////////////////////////////////////
	DEBUG_EVENT(if (l_lActivateTrace > 0) l_LogFile.Write("dump_remote_log_entries <%s> Event:%lu len: %lu net->read_pos[5]: %d", logname, countEvent++, len, net->read_pos[5]);)
	////////////////////////////////////////
  ...
  // ADD GAMMA
  ////////////////////////////////////////
  DEBUG_EVENT(if (l_lActivateTrace > 0) l_LogFile.Write("dump_remote_log_entries <%s> event:%lu OK", logname,countEvent);)
  ////////////////////////////////////////
...
// 
//////////////////////////////////////////////////////////////////////////////////
void PrintfResult(char *msg)
{
	fprintf(result_file, msg);
}
...
//////////////////////////////////////////////////////////////////////////////////
void InitMySql(const char *pszAppName)
{
	MY_INIT(pszAppName);
...
// 
//////////////////////////////////////////////////////////////////////////////////
void MySetVerbose(int iVerbose)
{
	verbose = (uint)iVerbose;
}

//////////////////////////////////////////////////////////////////////////////////
// 																		
//////////////////////////////////////////////////////////////////////////////////
void MySetTrace(int trace, int level)
{
	l_lActivateTrace = trace;
	l_lTraceLevel = level;
	if (l_lActivateTrace)
	{
		char appPath[512];
		...
		char *pszBackSlash = (char*)strrchr(appPath, '\\');
		*pszBackSlash = 0;
		sprintf(logName, "%s_dll_", ++pszBackSlash);

		l_LogFile.SetBufferSize(8000);
		l_LogFile.SetArchive(3);
		l_LogFile.SetDisplay(false);
		l_LogFile.Open(appPath, logName, "log", false);
		l_LogFile.Write("**************************************************************");
		l_LogFile.Write("**************************************************************");
		l_LogFile.Write("**************************************************************");
		l_LogFile.Write("%s (%s %s) started", logName, VERSION, __DATE__);
	}
}
...
// 																		
//////////////////////////////////////////////////////////////////////////////////
Exit_status InitRemoteReadBinLog(const char *pszAppName, const char *pszHost, const char *pszUser, const char *pszPassword, const char *pszPort)
{
	Exit_status retval = OK_CONTINUE;
	char szHost[250];
	char szUser[250];
	...
	sprintf(szHost, "--host=%s", pszHost);
	sprintf(szUser, "--user=%s", pszUser);
	sprintf(szPassword, "--password=%s", pszPassword);
	sprintf(szPort, "--port=%s", pszPort);
	...
	char **argv = argv_remote;
	int argc = 10;

	if (l_lActivateTrace)
		for (int i = 0; i<argc; i++) l_LogFile.Write("InitRemoteReadBinLog[a] Arg %d:[%s]", i, argv[i]);

	//printf("InitRemoteReadBinLog load_defaults...\n");

	if (load_defaults("my", load_groups, &argc, &argv))
	{
		if (l_lActivateTrace) l_LogFile.Write("InitRemoteReadBinLog error load_defaults");
		return  ERROR_STOP;
	}

	//printf("InitRemoteReadBinLog load_defaults OK\n");

	l_defaults_argv = argv;

	if (l_lActivateTrace)
		for (int i = 0; i<argc; i++) l_LogFile.Write("InitRemoteReadBinLog[b] Arg %d:[%s]", i, argv[i]);

	if (!(binlog_filter = new Rpl_filter))
	{
		if (l_lActivateTrace) l_LogFile.Write("InitRemoteReadBinLog Failed to create Rpl_filter");
		return  ERROR_STOP;
	}
	...
	if (l_lActivateTrace)
		for (int i = 0; i<argc; i++) l_LogFile.Write("InitRemoteReadBinLog[c] Arg %d:[%s]", i, argv[i]);
...
// 																		
//////////////////////////////////////////////////////////////////////////////////
Exit_status FreeReadBinLog(void)
{
	Exit_status retval = OK_CONTINUE;
...
// 																		
//////////////////////////////////////////////////////////////////////////////////
Exit_status StartReadBinLog(const char* pszLogName, unsigned long ulStartPosition, unsigned long ulIndex)
{
	Exit_status retval = OK_CONTINUE;

	if (l_lActivateTrace && l_lTraceLevel>TRACE_LOOP) l_LogFile.Write("StartReadBinLog FileName:%s Position:%lu Index:%lu", pszLogName, ulStartPosition, ulIndex);
	
	l_ulIndex = ulIndex;
	start_position = ulStartPosition;
	...
	fprintf(result_file, "*!START_BINLOG!%s!%lu!*\n", pszLogName, l_ulIndex);
	...
	*/
	...
	fprintf(result_file, "*!END_BINLOG!%s!%lu!*\n", pszLogName, l_ulIndex);

	if (l_lActivateTrace && l_lTraceLevel>TRACE_LOOP)
	{
		char *pszResponse = retval == OK_CONTINUE ? "OK_CONTINUE" :
			retval == ERROR_STOP ? "ERROR_STOP" :
			retval == ERROR_STOP ? "OK_STOP" :
			"UNKNOW";

		l_LogFile.Write("StartReadBinLog FileName:%s Position:%lu dump_multiple_logs...retval:%d (%s)", pszLogName, ulStartPosition, retval, pszResponse);
	}
	return retval;
}
...
int main_binlog(int argc, char** argv)
{
  char **defaults_argv;
  Exit_status retval= OK_CONTINUE;
  ...
  for (int i = 0; i<argc; i++) printf("main_binlog Arg %d:[%s]\n", i, argv[i]);
